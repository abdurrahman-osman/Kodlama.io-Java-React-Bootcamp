...
public class RORExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RORDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RORStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RORDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RORDateTimeConverter dateTimeConverter = new RORStandardDateTimeConverter();

    public RORExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RORExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RORMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RORHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RORExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RORHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
