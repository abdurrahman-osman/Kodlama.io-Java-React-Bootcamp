...
public class RORKPSPublicSoap
{
    ...
    public RORKPSPublicSoap(){}

    public RORKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RORKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RORExtendedSoapSerializationEnvelope envelope= new RORExtendedSoapSerializationEnvelope(RORExtendedSoapSerializationEnvelope.VER11);
