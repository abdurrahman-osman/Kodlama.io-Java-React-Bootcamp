...
public class HNSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HNSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HNSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HNSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HNSDateTimeConverter dateTimeConverter = new HNSStandardDateTimeConverter();

    public HNSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HNSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HNSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HNSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HNSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HNSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
