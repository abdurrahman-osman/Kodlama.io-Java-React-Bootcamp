...
public class HNSKPSPublicSoap
{
    ...
    public HNSKPSPublicSoap(){}

    public HNSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HNSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HNSExtendedSoapSerializationEnvelope envelope= new HNSExtendedSoapSerializationEnvelope(HNSExtendedSoapSerializationEnvelope.VER11);
